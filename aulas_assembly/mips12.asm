...
.text
	...
	imprime_par:
		...
		#SE EU NÃO PARAR O PROGRAMA AQUI, ELE VAI CONTINUAR EXECUTANDO, PASSANDO PELA INSTRUÇÃO DE IMPRIMIR ÍMPAR
		j exit_program #POR ISSO, CRIO UMA NOVA LABEL, RESPONSÁVEL PARA SAIR DO PROGRAMA E USO A INSTRUÇÃO JUMP PARA PULAR PRA ELA
	...
	exit_program:
		li $v0, 10 #INSTRUÇÃO QUE FECHA O PROGRAMA
		syscall
